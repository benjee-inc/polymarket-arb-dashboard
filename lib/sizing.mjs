...
export const STRATEGY_B = {
  ...
  // Sizing: small bets, big sample size — law of large numbers
  sizing: {
    tiers: [
      { minEdge: 0.00, maxEdge: 0.50, pctOfBankroll: 0.005 },  // Default: 0.5% of bankroll
      { minEdge: 0.50, maxEdge: 0.80, pctOfBankroll: 0.01 },   // Plausible: 1%
      { minEdge: 0.80, maxEdge: 1.00, pctOfBankroll: 0.02 },   // Confirmed catalyst: 2%
    ],
    absoluteMin: 0.25,    // Minimum $0.25 (even for tiny bankrolls)
    maxPctOfBankroll: 0.02, // Hard cap: 2% on lottery
  },
